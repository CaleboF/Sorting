...
public class SortingDriver {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nSelection Sort...");
        com.example.SortingUtility.selectionSort(copy1);
        printFirstTenOfArray(copy1);

        System.out.println("\nInsertion Sort...");
        com.example.SortingUtility.insertionSort(copy2);
        printFirstTenOfArray(copy2);

        System.out.println("\nBubble Sort...");
        com.example.SortingUtility.bubbleSort(copy3);
        printFirstTenOfArray(copy3);

        System.out.println("\nQuick Sort...");
        com.example.SortingUtility.quickSort(copy4);
        printFirstTenOfArray(copy4);

        System.out.println("\nMerge Sort...");
        com.example.SortingUtility.mergeSort(copy5);
